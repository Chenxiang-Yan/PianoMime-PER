...
from PER import RolloutPrioritizedReplayBuffer, PERPPO
...
def main(args: Args) -> None:
    ...
    if args.pretrained is not None:
        ...
        model = PERPPO.load(args.pretrained, env=vec_env, custom_objects=custom_objects)
    best_f1 = -np.inf
    ...
    model = PERPPO.load("./robopianist_rl/ckpts/{}_best".format(run_name), env=vec_env)
